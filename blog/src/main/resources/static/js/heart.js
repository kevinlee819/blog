...
$('.togglemenu').click(function () {
    $('.mitem').toggleClass('my-mobile-hide')
});
//暗色主题
$('.darkTheme').click(function () {
    ...
    $(".comment>.content>.metadata>.date").attr("style", "color:dimgrey;");
    $(".comment>.content>.text").attr("style", "color:grey;");
    $(".comment>.content>.actions>.reply").attr("style", "color:grey;");
});
$('.lightTheme').click(function () {
    ...
    $(".comment>.content>.metadata>.date").removeAttr("style");
    $(".comment>.content>.text").removeAttr("style");
    $(".comment>.content>.actions>.reply").removeAttr("style");
});
//吸顶效果
$('.ui.sticky')
    .sticky();
